...
def aplicar_descanso(request, tipo):
    ...
    if p:
        if tipo == "longo":
            ...
            p.recursos.filter(recuperacao="curto").update(usos_restantes=F("usos_totais"))
    return redirect("combate")
